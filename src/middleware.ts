...
const publicPrefixes = ["/blogs", "/leadership", "/events", "/spotlight", "/staffing", "/india-staffing", "/middle-east-staffing", "/referral", "/about", "/contact"];
...
export const config = {
    matcher: [
        "/((?!api|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|mp4|pdf)$).*)",
    ],
};
