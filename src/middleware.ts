...
export function middleware(request: NextRequest) {
  ...
  const hasAccess =
    roleBasedRoutes[userRole]?.some((route) => pathname.startsWith(route)) ??
    false;

  // If user doesn't have access and it's not a common route, redirect to their dashboard instead of unauthorized
