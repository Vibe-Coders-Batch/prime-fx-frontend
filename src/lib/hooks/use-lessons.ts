...
export const useUpdateLesson = () => {
  ...
  const fetchUpdateLessonMutationFunction = async ({
    id,
    dto,
  }: {
    id: string;
...
export const useReorderLessons = () => {
  ...
  const fetchReorderLessonsMutationFunction = async ({
    sectionId,
    lessons,
  }: {
    sectionId: string;
...
export const useUpdateQuizQuestions = () => {
  ...
  const fetchUpdateQuizQuestionsMutationFunction = async ({
    lessonId,
    questions,
  }: {
    lessonId: string;
...
export const useUpdateSection = () => {
  ...
  const fetchUpdateSectionMutationFunction = async ({
    id,
    dto,
  }: {
    id: string;
...
export const useDeleteSection = () => {
  ...
  const fetchDeleteSectionMutationFunction = async ({
    id,
    courseId,
  }: {
    id: string;
...
export const useReorderSections = () => {
  ...
  const fetchReorderSectionsMutationFunction = async ({
    courseId,
    modules,
  }: {
    courseId: string;
    modules: { sectionId: string; order: number }[];
  }): Promise<void> => {
