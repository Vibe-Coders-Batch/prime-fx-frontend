...
export const useCreateCourse = () => {
  ...
  const fetchCreateCourseMutationFunction = async (
...
export const useUpdateCourse = () => {
  ...
  const fetchUpdateCourseMutationFunction = async ({
    id,
    dto,
  }: {
    id: string;
...
export const useApproveCourse = () => {
  ...
  const fetchApproveCourseMutationFunction = async ({
    id,
    notes,
    publish,
  }: {
...
export const useRejectCourse = () => {
  ...
  const fetchRejectCourseMutationFunction = async ({
    id,
    reason,
  }: {
    id: string;
...
export const useRequestCourseChanges = () => {
  ...
  const fetchRequestCourseChangesMutationFunction = async ({
    id,
    notes,
  }: {
    id: string;
