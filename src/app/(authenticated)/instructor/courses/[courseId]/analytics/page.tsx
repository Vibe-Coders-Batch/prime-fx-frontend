...
export default function CourseAnalyticsPage({
  ...
  return (
    ...
    >
      <PageLayout
        header={`Course Analytics: ${course.title}`}
                    ...
                    [
                      {
                        ...
                        "Completion Rate": `${performance.completionRate.toFixed(
                          2
                        )}%`,
                        "Average Progress": `${performance.averageProgress.toFixed(
                          2
                        )}%`,
                      },
                    ],
      ...
      >
        ...
        >
          ...
          <AnimatedMetricCard
            ...
            value={performance?.averageProgress || 0}
            icon={TrendingUp}
