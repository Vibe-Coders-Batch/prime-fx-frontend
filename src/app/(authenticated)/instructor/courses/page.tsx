            ...
            return (
              ...
              >
                {course.thumbnail ? (
                  ...
                  <div className="aspect-video w-full bg-muted flex items-center justify-center rounded-t-lg relative">
                ...
                <CardHeader>
                  ...
                  {(isRejected || isChangesRequested) && (course.rejectionReason || course.reviewNotes) && (
                      <div className="mt-3 p-2 bg-red-50 dark:bg-red-900/20 text-xs text-red-600 dark:text-red-400 rounded border border-red-100 dark:border-red-900/50">
