...
import { Users, BookOpen, DollarSign, TrendingUp, PlusCircle, FileEdit, AlertCircle, Trash2, Video, } from "lucide-react";
        ...
        <Card className="lg:col-span-2 order-2 lg:order-1">
          ...
          <CardContent>
            <div className="space-y-4">
              {stats?.recentCourses && stats.recentCourses.length > 0 ? (stats.recentCourses.map((course: any) => (<div key={course.courseId} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b last:border-0 pb-4 last:pb-0">
