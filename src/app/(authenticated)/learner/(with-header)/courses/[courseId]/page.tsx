...
export default function CourseDetailPage({
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      // Error handled by hook via toast.promise
    }
  };

  if (isLoading) {
    return (
      <div className="min-h-screen bg-background px-6 pb-6 space-y-6 mx-auto">
  ...
  const discount = Math.round(
    ((originalPrice - parseFloat(course.price)) / originalPrice) * 100
  );
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {/* Explore related topics - Removed as no dynamic data available yet */}
          ...
          <div>
            ...
            <div className="space-y-4">
              {course.sections?.map((section, idx) => {
                ...
                return (
                  <div key={section.sectionId} className="border rounded-lg p-5 bg-card hover:shadow-md transition-shadow">
                    <div className="flex items-start justify-between mb-2">
                      <h3 className="font-semibold text-lg">
                        Section {idx + 1}: {section.title}
                      </h3>
                      {!isEnrolled && canPurchaseSeparately && sectionPrice > 0 && (
                        <div className="flex items-center gap-2">
                          {isSectionAccessible ? (
            ...
            <div className="space-y-3">
                {isEnrolled ? (
                   <Button
                    ...
                    size="lg"
                    onClick={() => router.push(`/learner/courses/${courseId}/watch`)}
                  >
                    Go to Course
                  </Button>
                ) : (
                  <>
                    ...
                    <Button
                      ...
                      disabled={createEnrollment.isPending || createPayment.isPending}
                    >
