          ...
          >
            <div className="relative mb-8 group cursor-pointer">
              <motion.div 
                 ...
                 className="rounded-full bg-red-500/10 p-8 shadow-2xl shadow-red-500/20"
              >
            ...
            >
              <Button 
                onClick={() => router.push("/learner/cart")}
                size="lg"
              ...
              <Button 
                ...
                size="lg"
                className="w-full h-12 text-base hover:bg-muted/50 border-muted-foreground/20"
              >
