...
import { Tag, Plus, Search, MoreHorizontal, Pencil, Trash2, Power, PowerOff, } from "lucide-react";
...
export default function AdminCouponsPage() {
    ...
    return (<PageLayout header="Coupon Management" description="Create and manage discount coupons for your courses">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between">
          <div className="flex flex-col sm:flex-row gap-2 flex-1">
            <div className="relative flex-1 max-w-md">
              ...
              <Input placeholder="Search by coupon code..." value={search} onChange={(e) => setSearch(e.target.value)} className="pl-8 h-9"/>
            </div>
