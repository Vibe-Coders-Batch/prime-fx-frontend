...
export default function ContentModerationPage() {
    ...
    return (<PageLayout header="Content Moderation" description="Review and moderate course content before publication.">
        ...
        <Card>
          ...
          <CardContent>
            <div className="relative">
              ...
              <Input placeholder="Search pending courses..." value={search} onChange={handleSearchChange} className="pl-9"/>
            </div>
          </CardContent>
        </Card>
