    ...
    return (<PageLayout header="Company Management" description="Manage corporate accounts and their enrollments." actions={<Button onClick={() => {
      ...
      <div className="space-y-6">
        ...
        {isLoading ? (<div className="space-y-4">
            ...
            (Array.isArray(companiesData) && companiesData.length === 0) ? (<EmptyState title="No companies found" description="Corporate accounts will appear here once created." icon={<Building2 className="h-12 w-12"/>}/>) : (<Card>
            <CardContent className="p-0">
              <div className="overflow-x-auto">
                <Table>
                  ...
                  <TableBody>
                    {(Array.isArray(companiesData) ? companiesData : []).map((company: Company) => (<TableRow key={company.id}>
                          ...
                          <TableCell className="text-right">
                            <div className="flex justify-end gap-2">
                              ...
                              <Button variant="destructive" size="sm" disabled={deleteCompany.isPending} onClick={async () => {
