      ...
      <Card className="relative border-2 border-border/50 shadow-xl h-full group hover:shadow-2xl transition-all duration-300 bg-card/50 backdrop-blur-sm">
        ...
        <CardHeader className="relative z-10 pb-3 sm:pb-6">
          <div className="flex items-center justify-between mb-2 gap-2">
            ...
            <motion.div
              className={`p-2 sm:p-3 rounded-xl bg-gradient-to-br ${gradient} shadow-lg flex-shrink-0`}
        ...
        <CardContent className="relative z-10 pt-0">
          ...
          {(suffix === "%" || title.includes("Rate") || title.includes("Progress")) && (
            <motion.div
              className="mt-3 sm:mt-4 h-2 bg-muted rounded-full"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
