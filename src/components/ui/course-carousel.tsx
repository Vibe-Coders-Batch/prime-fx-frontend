  ...
  return (
    <div className={cn("space-y-4", className)}>
      ...
      <div className="relative group">
        <div
          ref={scrollRef}
          className="flex gap-4 overflow-x-auto overflow-y-visible scrollbar-hide scroll-smooth pb-8 px-2 sm:px-2"
          style={{
            scrollbarWidth: "none",
        ...
        >
          {courses.map((course, index) => {
            ...
            return (
              <motion.div
                key={courseId}
                className="flex-shrink-0 w-[calc(100vw-2rem)] sm:w-[320px] md:w-[360px] snap-start"
                transition={{
                  duration: 0.3,
                  delay: index * 0.05,
                  ease: [0.4, 0, 0.2, 1],
              ...
              >
                <Card
                  className={cn(
                    "overflow-hidden border-0 shadow-lg bg-card/50 backdrop-blur-sm group/card flex flex-col transition-all duration-300 h-[400px]",
                    hoveredIndex === index &&
                ...
                >
                  ...
                  <div
                    className={cn(
                      "p-4 flex flex-col flex-1 bg-card relative transition-colors duration-300",
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between shrink-0 mt-2 pt-2 border-t border-border/50">
                      ...
                      <Link 
                        href={isEnrolled ? `/learner/courses/${courseId}/watch` : `/learner/courses/${courseId}`}
                      ...
                      >
                        <Button
                          ...
                          size="sm"
                          className={cn(
                            "text-xs transition-all duration-200 pointer-events-auto",
                            hoveredIndex === index &&
