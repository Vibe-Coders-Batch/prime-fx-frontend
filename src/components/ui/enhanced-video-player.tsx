  ...
  (
      ...
      if (Hls.isSupported()) {
        ...
        const hls = new Hls({
          ...
          xhrSetup: (xhr: XMLHttpRequest, url: string) => {
            // Set XHR timeout to match HLS timeout
            xhr.timeout = 20000;
        ...
        hls.on(Hls.Events.SUBTITLE_TRACKS_UPDATED, (_, data) => {
          const tracks: SubtitleTrack[] = data.subtitleTracks.map(
            (track, idx) => ({
              id: idx,
    ...
    return (
      <div
        ref={containerRef}
        className={cn(
          "group relative overflow-hidden bg-black aspect-video rounded-lg select-none",
          className
        )}
      ...
      >
        ...
        {/* Error Overlay */}
        {error && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-b from-gray-900 to-black z-20 p-6">
        ...
        <div
          className={cn(
            "absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/60 to-transparent z-10 transition-all duration-300",
        ...
        >
          ...
          >
            ...
            {/* Thumb */}
            <div
              className="absolute top-1/2 -translate-y-1/2 w-3 h-3 bg-primary rounded-full opacity-0 group-hover/progress:opacity-100 transition shadow-lg"
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="flex items-center group/volume">
                ...
                <input
                  ...
                  className="w-0 group-hover/volume:w-20 transition-all duration-300 accent-primary h-1 cursor-pointer"
                  aria-label="Volume"
                />
              </div>
              ...
              {subtitleTracks.length > 0 && (
                <button
                  ...
                  className={cn(
                    ...
                    currentSubtitle >= 0 ? "text-primary" : "text-white"
                  )}
          ...
          {showSettings && (
            <div
              className="absolute bottom-16 right-4 w-56 bg-gray-900/95 backdrop-blur-sm rounded-lg shadow-2xl overflow-hidden border border-white/10"
              ...
              {settingsMenu === "main" && (
                <div className="p-1">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 hover:bg-white/10 rounded-md transition text-white"
                  >
              ...
              {settingsMenu === "quality" && (
                <div className="p-1">
                  <button
                    ...
                    className="w-full flex items-center gap-2 p-3 hover:bg-white/10 rounded-md transition text-white border-b border-white/10"
                  >
