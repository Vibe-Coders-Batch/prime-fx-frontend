      ...
      <Card className="relative border-none shadow-lg h-full">
        ...
        <CardHeader className="relative pb-3 sm:pb-6">
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm sm:text-base md:text-lg font-semibold">{title}</CardTitle>
            {Icon && (<div className={cn("p-2 sm:p-3 rounded-lg", gradient
        ...
        <CardContent className="relative pt-0">
          <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{
            ...
            stiffness: 200,
            damping: 15,
        }} className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-br from-foreground to-muted-foreground bg-clip-text text-transparent break-words">
            {value}
          </motion.div>
          {trend && (<div className={cn("text-sm mt-2", trend.isPositive ? "text-green-600" : "text-red-600")}>
