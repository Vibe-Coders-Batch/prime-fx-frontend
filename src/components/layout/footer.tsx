        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <nav aria-label="Social media links">
            <ul className="flex items-center gap-6">
              <li>
                <a href="https://x.com/learning13190" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-primary-gold transition-colors" aria-label="Follow us on X">
              ...
              <li>
                <a href="https://www.linkedin.com/company/prime-learning-ae/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-primary-gold transition-colors" aria-label="Connect with us on LinkedIn">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <li>
                <a href="https://www.instagram.com/primelearningofficial/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-primary-gold transition-colors" aria-label="Follow us on Instagram">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
