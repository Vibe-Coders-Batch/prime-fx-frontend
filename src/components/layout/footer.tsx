      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
        ...
        <nav aria-label="Academy navigation">
          ...
          <ul className="space-y-2 text-sm text-white/60">
            <li>
              <Link href="#why-prime-learning" className="hover:text-primary-gold transition-colors">
                About Us
              </Link>
            </li>
            <li>
              <Link href="/learner/courses" className="hover:text-primary-gold transition-colors">
                Courses
              </Link>
            </li>
            <li>
              <Link href="#categories" className="hover:text-primary-gold transition-colors">
                Categories
              </Link>
            </li>
            <li>
        ...
        <nav aria-label="Resources navigation">
          ...
          <ul className="space-y-2 text-sm text-white/60">
            <li>
              <Link href="/blogs" className="hover:text-primary-gold transition-colors">
                Blog
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/signup" className="hover:text-primary-gold transition-colors">
                Start Learning Today
              </Link>
            </li>
            <li>
              <Link href="#courses" className="hover:text-primary-gold transition-colors">
                Popular Courses
              </Link>
            </li>
          </ul>
        ...
        <nav aria-label="Legal navigation">
          ...
          <ul className="space-y-2 text-sm text-white/60">
            ...
            <li>
              <Link href="/terms-of-service" className="hover:text-primary-gold transition-colors">
                Terms of Service
              </Link>
            </li>
          </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <nav aria-label="Social media links">
            <ul className="flex items-center gap-6">
              <li>
                <a href="https://twitter.com/primetraining" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-primary-gold transition-colors" aria-label="Follow us on Twitter">
              ...
              <li>
                <a href="https://www.linkedin.com/company/prime-elearning" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-primary-gold transition-colors" aria-label="Connect with us on LinkedIn">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <li>
                <a href="https://www.instagram.com/primeelearning" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-primary-gold transition-colors" aria-label="Follow us on Instagram">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
