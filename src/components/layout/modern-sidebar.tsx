  ...
  return (
    <>
      ...
      <Button
        variant="ghost"
        size="icon"
        className="fixed top-16 left-3 sm:top-20 sm:left-4 z-50 lg:hidden h-10 w-10 bg-background/95 backdrop-blur-sm border border-border shadow-lg hover:bg-background rounded-lg"
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed left-0 top-0 h-screen w-72 sm:w-80 border-r border-border bg-card shadow-2xl z-50 lg:hidden"
            >
              <div className="flex flex-col h-full">
                ...
                <div className="p-4 sm:p-6 border-t border-border">
                  <button
                    onClick={handleLogout}
                    className="flex items-center gap-3 px-4 py-3.5 rounded-xl text-base font-medium transition-all duration-200 w-full text-muted-foreground hover:bg-destructive/10 hover:text-destructive"
                  >
                    <span className="shrink-0 w-5 h-5">
                      <svg
      ...
      <motion.aside
        ...
        transition={{ duration: 0.3, ease: "easeInOut" }}
        className={cn(
          "hidden lg:block fixed left-0 top-0 h-screen border-r border-border bg-card z-40",
          className
        )}
      >
        <Button
          variant="ghost"
          size="icon"
          className="absolute -right-3 top-24 h-6 w-6 rounded-full border border-border bg-background shadow-md"
