...
export function LearnerNavbar() {
  ...
  return (
    <motion.header
      ...
      className={cn(
        "fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-3 sm:px-4 md:px-6 py-3 sm:py-4 transition-all duration-300",
        "bg-background/60 backdrop-blur-xl border-b border-border/40 shadow-lg"
      )}
    >
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <Link
          ...
          className="text-base sm:text-lg md:text-xl font-bold tracking-tight text-foreground flex items-center gap-1 sm:gap-2"
        >
          ...
          return (
            <Link key={item.href} href={item.href}>
              <Button
                ...
                size="sm"
                className={cn(
                  "gap-2 transition-all duration-200 rounded-lg font-medium",
                  isActive 
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <Button
          variant="ghost"
          size="icon"
          className="relative h-9 w-9 sm:h-10 sm:w-10 hover:bg-muted/50 transition-colors"
          asChild
        >
        ...
        {user && (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="relative h-9 w-9 sm:h-10 sm:w-10 rounded-full hover:bg-muted/50 transition-colors"
              >
