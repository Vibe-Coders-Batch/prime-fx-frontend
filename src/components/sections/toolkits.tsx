...
function ToolkitItem({
  ...
  return (
    <article
      ref={ref}
      className={`flex flex-col md:flex-row items-center gap-8 sm:gap-10 md:gap-16 lg:gap-24 py-8 sm:py-10 md:py-12 ${
    ...
    >
      ...
      <figure className="flex-1 w-full relative aspect-video bg-card/50 rounded-lg sm:rounded-xl overflow-hidden border border-border group m-0">
        ...
        <motion.div
          style={{ y }}
          className="absolute inset-0 w-full h-full p-4 sm:p-6 md:p-8 flex items-center justify-center z-10"
        >
...
export function Toolkits() {
  return (
    <section
      id="toolkits"
      className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-background"
