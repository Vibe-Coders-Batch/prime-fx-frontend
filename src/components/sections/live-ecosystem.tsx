...
export function LiveEcosystem() {
  ...
  return (
    <section
      id="markets"
      className="py-10 sm:py-12 md:py-16 px-4 sm:px-6 bg-background overflow-hidden"
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 sm:gap-12 md:gap-16 lg:gap-24">
        <div className="flex-1 space-y-5 sm:space-y-6 md:space-y-8 z-10 text-center md:text-left">
          ...
          <ul
            className="space-y-3 sm:space-y-4 list-none p-0"
            role="list"
        ...
        >
          <motion.div
            whileHover={{ y: -5 }}
            className="relative w-full h-full bg-card border border-border rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 shadow-xl flex flex-col justify-between overflow-hidden"
          >
            ...
            <div
              className="flex-1 bg-muted rounded-md sm:rounded-lg mb-3 sm:mb-4 relative overflow-hidden"
              role="img"
              ...
              <div className="absolute inset-0 flex items-end justify-around px-2 sm:px-4 pb-2 sm:pb-4">
                {[40, 60, 45, 70, 55, 80, 65, 90].map((h, i) => (
                  <motion.div
                    ...
                    className="w-2 sm:w-3 md:w-4 bg-primary rounded-t-sm opacity-80"
                    aria-hidden="true"
                  />
                ))}
              </div>
