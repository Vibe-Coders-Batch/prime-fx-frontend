...
import {
  useCourses as useAllCourses,
  useCourse as useSingleCourse,
  useCourseBySlug as useCourseSlug,
  useCreateCourse as useCreateCourseMutation,
  useUpdateCourse as useUpdateCourseMutation,
  useDeleteCourse as useDeleteCourseMutation,
  useSubmitCourseForReview as useSubmitMutation,
  useApproveCourse as useApproveMutation,
  useRejectCourse as useRejectMutation,
  useRequestCourseChanges as useRequestChangesMutation,
