...
export function CourseBuilder({ courseId }: CourseBuilderProps) {
    ...
    return (<div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        {(!modules || modules.length === 0) && !isAddingModule && (<div className="flex flex-col items-center justify-center p-8 border border-dashed rounded-lg bg-muted/20 text-muted-foreground">
