...
export function QuizBuilder({ questions, onChange }: QuizBuilderProps) {
  ...
  const handleRemoveOption = (qIndex: number, oIndex: number) => {
    ...
    if (oIndex < newCorrectIndex) newCorrectIndex--;
    if (newCorrectIndex >= newOptions.length) newCorrectIndex = newOptions.length - 1;
               ...
               <div className="flex-1 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <RadioGroup 
                        ...
                        onValueChange={(val) => handleUpdateQuestion(qIndex, { correctOptionIndex: parseInt(val) })}
                    >
