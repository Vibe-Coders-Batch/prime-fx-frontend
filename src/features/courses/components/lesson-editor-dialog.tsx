...
export function LessonEditorDialog({ open, onOpenChange, lessonId, courseId }: LessonEditorDialogProps) {
  ...
  useEffect(() => {
    if (lesson) {
      ...
      if (lesson.questions) {
        // Map backend questions to component state
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8">
                ...
                <div className="space-y-4">
                    ...
                    <Textarea 
                        ...
                        rows={3} 
                        className="resize-none p-4 transition-all"
                ...
                {lesson?.type === "VIDEO" && (
                    <div className="space-y-6 pt-2">
                        ...
                        {lessonId && (lesson?.status === 'READY' || lesson?.status === 'PROCESSING') && (
                ...
                {lesson?.type === "TEXT" && (
                    <div className="space-y-4 pt-2">
                        ...
                        <Textarea 
                            className="font-mono text-sm min-h-[400px] leading-relaxed p-6"
                            value={textContent} 
