  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        {validationErrors.length > 0 && !isPending && !isApproved && (
                    ...
                    <ul className="text-left text-sm space-y-2 bg-background p-4 rounded border inline-block min-w-[300px]">
                        ...
                        <li className="flex items-center gap-2">
                            <CheckCircle2 className={
                              course?.sections?.some(s => s.lessons?.length > 0) ? "text-green-500" : "text-gray-300"
                            } size={16} />
                        ...
                        <li className="flex items-center gap-2">
                            <CheckCircle2 className={
                              course?.price && Number(course.price) >= 0 ? "text-green-500" : "text-gray-300"
                            } size={16} />
